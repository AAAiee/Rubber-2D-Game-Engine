...
/**
* @breif Keycodes definitions, this is copied from GLFW.
* if need to use for other libraries, first convert them into the corresponding key code.
* e.g. convert function (look up table...etc) 
*/
...
#define RB_KEY_LAST               RB_KEY_MENU
